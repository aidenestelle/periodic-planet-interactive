// DEPRECATED: Use ElementsContext instead for element data loaded from elements.json
// Ensure the correct Element interface is used from '../types/ElementTypes'.
import type { Element } from "../types/ElementTypes";
...
export const periodicTableLayout = [
  // Period 1
  { number: 1, gridRow: 1, gridColumn: 1 },  // H
  { number: 2, gridRow: 1, gridColumn: 18 }, // He
  
  // Period 2
  { number: 3, gridRow: 2, gridColumn: 1 },  // Li
  { number: 4, gridRow: 2, gridColumn: 2 },  // Be
  { number: 5, gridRow: 2, gridColumn: 13 }, // B
  { number: 6, gridRow: 2, gridColumn: 14 }, // C
  { number: 7, gridRow: 2, gridColumn: 15 }, // N
  { number: 8, gridRow: 2, gridColumn: 16 }, // O
  { number: 9, gridRow: 2, gridColumn: 17 }, // F
  { number: 10, gridRow: 2, gridColumn: 18 }, // Ne
  
  // Period 3
  { number: 11, gridRow: 3, gridColumn: 1 }, // Na
  { number: 12, gridRow: 3, gridColumn: 2 }, // Mg
  { number: 13, gridRow: 3, gridColumn: 13 }, // Al
  { number: 14, gridRow: 3, gridColumn: 14 }, // Si
  { number: 15, gridRow: 3, gridColumn: 15 }, // P
  { number: 16, gridRow: 3, gridColumn: 16 }, // S
  { number: 17, gridRow: 3, gridColumn: 17 }, // Cl
  { number: 18, gridRow: 3, gridColumn: 18 }, // Ar
  
  // Period 4 (Not fully implemented yet)
  { number: 19, gridRow: 4, gridColumn: 1 }, // K
  { number: 20, gridRow: 4, gridColumn: 2 }, // Ca
  { number: 21, gridRow: 4, gridColumn: 3 }, // Sc
  { number: 22, gridRow: 4, gridColumn: 4 }, // Ti
  { number: 23, gridRow: 4, gridColumn: 5 }, // V
  { number: 24, gridRow: 4, gridColumn: 6 }, // Cr
  { number: 25, gridRow: 4, gridColumn: 7 }, // Mn
  { number: 26, gridRow: 4, gridColumn: 8 }, // Fe
  { number: 27, gridRow: 4, gridColumn: 9 }, // Co
  { number: 28, gridRow: 4, gridColumn: 10 }, // Ni
  { number: 29, gridRow: 4, gridColumn: 11 }, // Cu
  { number: 30, gridRow: 4, gridColumn: 12 }, // Zn
  { number: 31, gridRow: 4, gridColumn: 13 }, // Ga
  { number: 32, gridRow: 4, gridColumn: 14 }, // Ge
  { number: 33, gridRow: 4, gridColumn: 15 }, // As
  { number: 34, gridRow: 4, gridColumn: 16 }, // Se
  { number: 35, gridRow: 4, gridColumn: 17 }, // Br
  { number: 36, gridRow: 4, gridColumn: 18 }, // Kr
  
  // Period 5 (Not fully implemented yet)
  { number: 37, gridRow: 5, gridColumn: 1 }, // Rb
  { number: 38, gridRow: 5, gridColumn: 2 }, // Sr
  { number: 39, gridRow: 5, gridColumn: 3 }, // Y
  { number: 40, gridRow: 5, gridColumn: 4 }, // Zr
  { number: 41, gridRow: 5, gridColumn: 5 }, // Nb
  { number: 42, gridRow: 5, gridColumn: 6 }, // Mo
  { number: 43, gridRow: 5, gridColumn: 7 }, // Tc
  { number: 44, gridRow: 5, gridColumn: 8 }, // Ru
  { number: 45, gridRow: 5, gridColumn: 9 }, // Rh
  { number: 46, gridRow: 5, gridColumn: 10 }, // Pd
  { number: 47, gridRow: 5, gridColumn: 11 }, // Ag
  { number: 48, gridRow: 5, gridColumn: 12 }, // Cd
  { number: 49, gridRow: 5, gridColumn: 13 }, // In
  { number: 50, gridRow: 5, gridColumn: 14 }, // Sn
  { number: 51, gridRow: 5, gridColumn: 15 }, // Sb
  { number: 52, gridRow: 5, gridColumn: 16 }, // Te
  { number: 53, gridRow: 5, gridColumn: 17 }, // I
  { number: 54, gridRow: 5, gridColumn: 18 }, // Xe
  
  // Period 6 (Not fully implemented yet)
  { number: 55, gridRow: 6, gridColumn: 1 }, // Cs
  { number: 56, gridRow: 6, gridColumn: 2 }, // Ba
  { number: 57, gridRow: 8, gridColumn: 3 }, // La (moved to lanthanide row)
  { number: 72, gridRow: 6, gridColumn: 4 }, // Hf
  { number: 73, gridRow: 6, gridColumn: 5 }, // Ta
  { number: 74, gridRow: 6, gridColumn: 6 }, // W
  { number: 75, gridRow: 6, gridColumn: 7 }, // Re
  { number: 76, gridRow: 6, gridColumn: 8 }, // Os
  { number: 77, gridRow: 6, gridColumn: 9 }, // Ir
  { number: 78, gridRow: 6, gridColumn: 10 }, // Pt
  { number: 79, gridRow: 6, gridColumn: 11 }, // Au
  { number: 80, gridRow: 6, gridColumn: 12 }, // Hg
  { number: 81, gridRow: 6, gridColumn: 13 }, // Tl
  { number: 82, gridRow: 6, gridColumn: 14 }, // Pb
  { number: 83, gridRow: 6, gridColumn: 15 }, // Bi
  { number: 84, gridRow: 6, gridColumn: 16 }, // Po
  { number: 85, gridRow: 6, gridColumn: 17 }, // At
  { number: 86, gridRow: 6, gridColumn: 18 }, // Rn
  
  // Period 7 (Not fully implemented yet)
  { number: 87, gridRow: 7, gridColumn: 1 }, // Fr
  { number: 88, gridRow: 7, gridColumn: 2 }, // Ra
  { number: 89, gridRow: 9, gridColumn: 3 }, // Ac (moved to actinide row)
  { number: 104, gridRow: 7, gridColumn: 4 }, // Rf
  { number: 105, gridRow: 7, gridColumn: 5 }, // Db
  { number: 106, gridRow: 7, gridColumn: 6 }, // Sg
  { number: 107, gridRow: 7, gridColumn: 7 }, // Bh
  { number: 108, gridRow: 7, gridColumn: 8 }, // Hs
  { number: 109, gridRow: 7, gridColumn: 9 }, // Mt
  { number: 110, gridRow: 7, gridColumn: 10 }, // Ds
  { number: 111, gridRow: 7, gridColumn: 11 }, // Rg
  { number: 112, gridRow: 7, gridColumn: 12 }, // Cn
  { number: 113, gridRow: 7, gridColumn: 13 }, // Nh
  { number: 114, gridRow: 7, gridColumn: 14 }, // Fl
  { number: 115, gridRow: 7, gridColumn: 15 }, // Mc
  { number: 116, gridRow: 7, gridColumn: 16 }, // Lv
  { number: 117, gridRow: 7, gridColumn: 17 }, // Ts
  { number: 118, gridRow: 7, gridColumn: 18 }, // Og
];
...
export const fetchElementData = async (number: number): Promise<Element | undefined> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve(getElementByNumber(number));
    }, 300);
  });
};
